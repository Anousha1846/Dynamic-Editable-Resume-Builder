...
const generateResume = (event: Event) => {
   ...
   reader.onload = function(event) {
    ...
    // user input save here
    currentResumeData = { name, email, phone, dateOfBirth, profilePicture, jobTitle, company, duration, degree, institution, year, professionalSkill, softSkill };

    // make resume , output aaega
    let resumeHTML = `<br>
    ...
    // Show  edit button after resume making
